...
const PROJECTS = {
    weather: {
        ...
        screenshots: [], // Add real screenshot paths here e.g. ['img/weather-1.png', 'img/weather-2.png']
    ...
    notes: {
        title: 'Notes App',
        shortDesc: 'Clean note-taking with rich text, categories, and local persistence.',
        fullDesc:
            'A polished notes application with a Material You-inspired design. Users can create, edit, and organise notes with rich formatting including bold, italic, and lists. Notes are grouped into colour-coded categories and stored locally using Hive, a lightweight NoSQL database — so everything works completely offline. Swipe-to-delete with undo toast, pin-to-top, and archive features round out the experience.',
    ...
    tasks: {
        ...
        shortDesc: 'Productivity app with priorities, reminders, and progress tracking.',
        fullDesc:
            'A comprehensive task manager designed to boost personal productivity. Users can create tasks with three priority levels (high, medium, low), assign them to custom categories, and set due-date reminders that fire local push notifications via flutter_local_notifications. A home screen dashboard displays animated circular progress charts showing daily completion rates, keeping users motivated.',
        gradient: 'linear-gradient(135deg, #00695c 0%, #00b894 50%, #55efc4 100%)',
        accentColor: '#00b894',
        tags: ['Flutter', 'GetX', 'Firebase', 'Notifications'],
        tech: [
            { name: 'Flutter 3.x',       dot: '#54c5f8' },
            { name: 'Dart',              dot: '#00b4d8' },
            { name: 'GetX',              dot: '#00b894' },
